...
void GameLayer::OnUpdate(Sas::Timestep ts)
{
	m_Time += ts;
...
void GameLayer::OnEvent(Sas::Event& e)
{
	...
	dispatcher.Dispatch<WindowResizeEvent>(SS_BIND_EVENT_FN(GameLayer::OnWindowResize));
	dispatcher.Dispatch<MouseButtonPressedEvent>(SS_BIND_EVENT_FN(GameLayer::OnMouseButtonPressed));
}

bool GameLayer::OnMouseButtonPressed(Sas::MouseButtonPressedEvent& e)
{
...
bool GameLayer::OnWindowResize(Sas::WindowResizeEvent& e)
{
